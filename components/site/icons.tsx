 ...
 * Platform glyphs.
 *
 * Official vector brand marks for YouTube, Instagram, LinkedIn, and X/Twitter.
 * Designed to render sharply at any scale with fill="currentColor".
 */
...
export const PlayGlyph = YoutubeGlyph;
export const CameraGlyph = InstagramGlyph;
export const NetworkGlyph = LinkedinGlyph;
...
export const GLYPHS = {
  ...
  camera: InstagramGlyph,
  instagram: InstagramGlyph,
  network: LinkedinGlyph,
